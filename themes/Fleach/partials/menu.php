<nav data-scroll-header class="header-modal">
  <div class="header-modal__left">
    ...
    <a href="<?php echo get_permalink( get_page_by_title( 'Investisseurs' ) ) ?>" class="paragraph--16 paragraph--16--white mr--40 d-none--mobile d-none--tablet header-modal__active">
    Investisseurs
    </a>
    <a href="<?php echo get_permalink( get_page_by_title( 'Entrepreneurs' ) ) ?>" class="paragraph--16 paragraph--16--white d-none--mobile d-none--tablet">
    Entrepreneurs
    </a>
  </div>
